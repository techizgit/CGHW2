...
public class DummyGame implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        File TextureFile = new File("src/resources/textures/stone.png");
        InputStream textureInputStream = new FileInputStream(TextureFile);
        Texture texture = new Texture(textureInputStream);
        
        TextureFile = new File("src/resources/textures/stone_nrm.png");
        textureInputStream = new FileInputStream(TextureFile);
        Texture normalMap = new Texture(textureInputStream);
...
//        Material material = new Material(new Vector3f(0.2f, 0.5f, 0.5f), reflectance);
        ...
        gameItem.setPosition(-2.5f, -1.4f, -5f);
