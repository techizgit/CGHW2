...
public class Renderer {
    ...
    public ShaderProgram createChessShader() throws Exception {
        ShaderProgram shaderProgram = new ShaderProgram();

        shaderProgram.createVertexShader(new String(Files.readAllBytes(Paths.get("src/resources/shaders/chess_vertex.vs"))));
        shaderProgram.createFragmentShader(new String(Files.readAllBytes(Paths.get("src/resources/shaders/chess_fragment.fs"))));
        shaderProgram.link();
    ...
    public ShaderProgram createPFlatShader() throws Exception {
        ShaderProgram shaderProgram = new ShaderProgram();

        shaderProgram.createVertexShader(new String(Files.readAllBytes(Paths.get("src/resources/shaders/phongflat_vertex.vs"))));
        shaderProgram.createFragmentShader(new String(Files.readAllBytes(Paths.get("src/resources/shaders/phongflat_fragment.fs"))));
        shaderProgram.link();
    ...
    public void init(Window window) throws Exception {
        ...
        shaderProgramList.put("chess", createChessShader());
        shaderProgramList.put("phongflat", createPFlatShader());
    ...
    public void render(Window window, Camera camera, GameItem[] gameItems, Vector3f ambientLight,
        ...
        else if(currentShader.equals("chess")) {
        	shaderProgram.setUniform("projectionMatrix", projectionMatrix);
        ...
        else if(currentShader.equals("phongflat")) {
        	shaderProgram.setUniform("projectionMatrix", projectionMatrix);
